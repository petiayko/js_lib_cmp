...
import { color, merge } from 'chart.js/helpers';
...
PointWithErrorBar.defaults = { ...PointElement.defaults, ...errorBarDefaults };
...
ArcWithErrorBar.defaults = { ...ArcElement.defaults, ...errorBarDefaults };
...
function generateTooltipPolar(item) {
    const base = PolarAreaController.overrides.plugins.tooltip.callbacks.label.call(this, item);
    const v = item.chart.data.datasets[item.datasetIndex].data[item.dataIndex];
...
BarWithErrorBarsController.defaults = merge({}, [
...
BarWithErrorBarsController.overrides = merge({}, [
...
BarWithErrorBarsController.defaultRoutes = BarController.defaultRoutes;
...
LineWithErrorBarsController.defaults = merge({}, [
...
LineWithErrorBarsController.overrides = merge({}, [
...
LineWithErrorBarsController.defaultRoutes = LineController.defaultRoutes;
...
ScatterWithErrorBarsController.defaults = merge({}, [
...
ScatterWithErrorBarsController.overrides = merge({}, [
...
ScatterWithErrorBarsController.defaultRoutes = LineController.defaultRoutes;
class ScatterWithErrorBarsChart extends Chart {
    constructor(item, config) {
        super(item, patchController('scatterWithErrorBars', config, ScatterWithErrorBarsController, PointWithErrorBar, [LinearScale]));
    }
}
...
PolarAreaWithErrorBarsController.defaults = merge({}, [
...
PolarAreaWithErrorBarsController.overrides = merge({}, [
...
PolarAreaWithErrorBarsController.defaultRoutes = PolarAreaController.defaultRoutes;
