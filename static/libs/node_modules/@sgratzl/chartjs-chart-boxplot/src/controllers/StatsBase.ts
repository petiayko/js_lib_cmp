...
import { interpolateNumberArray } from '@sgratzl/chartjs-chart-boxplot/src/animation';
import { outlierPositioner, patchInHoveredOutlier } from '@sgratzl/chartjs-chart-boxplot/src/tooltip';
import { defaultStatsOptions, IBaseOptions, IBaseStats } from '@sgratzl/chartjs-chart-boxplot/src/data';
